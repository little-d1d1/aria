...
class TestPackageImports(unittest.TestCase):
    ...
    def test_polynomial_import(self):
        ...
        try:
            from aria.utils.srk import polynomial
    ...
    def test_smt_import(self):
        ...
        try:
            from aria.utils.srk import smt
    ...
    def test_abstract_import(self):
        ...
        try:
            from aria.utils.srk import abstract
    ...
    def test_linear_import(self):
        ...
        try:
            from aria.utils.srk import linear
    ...
    def test_interval_import(self):
        ...
        try:
            from aria.utils.srk import interval
    ...
    def test_polyhedron_import(self):
        ...
        try:
            from aria.utils.srk import polyhedron
    ...
    def test_simplify_import(self):
        ...
        try:
            from aria.utils.srk import Simplifier
    ...
    def test_util_import(self):
        ...
        try:
            from aria.utils.srk import util
...
class TestPackageStructure(unittest.TestCase):
    ...
    def test_package_version(self):
        ...
        try:
            from aria.utils.srk import __version__
    ...
    def test_package_author(self):
        ...
        try:
            from aria.utils.srk import __author__
    ...
    def test_star_import_smoke(self):
        ...
        namespace = {}
        try:
            exec("from aria.utils.srk import *", namespace)
