...
Example:
    >>> from aria.utils.srk.polynomial import Polynomial, MonomialOrder
...
def qq_term_of(srk: Any, term: ArithExpression, poly: "UnivariatePolynomial") -> ArithExpression:
    ...
    """
    from aria.utils.srk.syntax import mk_add, mk_mul, mk_real, mk_pow, mk_const
    from aria.utils.srk.linear import linterm_of
